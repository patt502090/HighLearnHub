...
export default function AddCoursePage() {
    ...
    const handleSubmit = async () => {
        try {
            const response = await ax.post('http://localhost:1337/api/courses', { data : courseData });
                ...
                <div className="mx-10 lg:mx-auto flex flex-col items-center justify-items-center w-auto sm:w-full">
                    <div className="mt-4 w-full xl:w-2/3 2xl:w-1/2 p-8 sm:p-16 2xl:p-12 bg-white shadow-lg rounded-lg ">
                        ...
                        <div className="grid lg:grid-cols-2 gap-4">
                            ...
                            {courseData.study_type === "Live" ? <div>
                                <Label htmlFor="amount_type" value="รับนักเรียนจำนวน" />
                                <TextInput
                                    id="amount_type"
                                    name="amount"
                                    placeholder="จำนวน"
                        ...
                        <div className="flex justify-center mt-8">
                            <button onClick={handleSubmit} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">เพิ่มคอร์ส</button>
                        </div>
                    </div>
                </div>
            </div>
